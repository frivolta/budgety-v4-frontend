...
export const ExpenseCountWidget: React.FC = () => {
  ...
  <>
    <StdCard className="ExpenseCountWidget ExpenseCountWidget--primary">
      <div className="ExpenseCountWidget__caption">Expenses: <span>- {convertAmountToCurrency(expenses)}</span></div>
    </StdCard>
    <StdCard className="ExpenseCountWidget  ExpenseCountWidget--alt">
      <div className="ExpenseCountWidget__caption">Incomes: <span>+ {convertAmountToCurrency(incomes)}</span></div>
    </StdCard>
    <StdCard className="ExpenseCountWidget">
      <div className={`ExpenseCountWidget__caption ${positiveSymbol ? 'ExpenseCountWidget__caption--positive' : 'ExpenseCountWidget__caption--negative' }`}>Total: <span>{convertAmountToCurrency(total)}</span></div>
    </StdCard>
  </>
  );
};
